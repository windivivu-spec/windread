  ...
  "@graph": [
    {
      ...
      url: siteUrl,
      logo: `${siteUrl}/images/windread-google-logo.jpg`,
      image: `${siteUrl}/images/hero-dreadlocks-v2.png`,
      description: "WINDREAD là Hair Culture Club -Since 2020 tại Đà Nẵng, chuyên Locs, Dreadlocks, Barber, Afro Hair, Braids và Cornrows. Không gian dành cho những người yêu hair culture, street style và phong cách cá nhân.",
